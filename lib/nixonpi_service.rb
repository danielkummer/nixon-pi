...
require_relative 'nixonpi/handlers/bar_handler_sate_machine'
require_relative 'nixonpi/handlers/tube_handler_state_machine'
require_relative 'nixonpi/handlers/lamp_handler_state_machine'
require_relative 'nixonpi/animations/animation'
require_relative 'nixonpi/web/web_server'
require_relative 'nixonpi/handlers/machine_manager'
