...
FLAG  bsc_write (BSC_MEMIO_CTX *p, I2C_WRITE_IO *io)
{
    U32     st_mask;
...
FLAG  bsc_read (BSC_MEMIO_CTX *p, I2C_READ_IO *io)
{
...
static  I2C_WRITE_IO    bsc_write_reg_io = { &bsc_write_reg_data, 1, 0, 0b0000000 };
...
static  I2C_READ_IO     bsc_read_reg_io = { &bsc_read_reg_data, 1, 0, 0b0000000 };
